Sub Main ()
    ...
    projectVba = "ApplicationProject" ' Project's name where the macro will be ran
    moduleVba = "ModFileBrowser" 'Module within the project that contains the macro
    macroVba = "BrowseLocation" 'Name of the macro to run

	InventorVb.RunMacro(projectVba, moduleVba, macroVba)
